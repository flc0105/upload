...
const app = Vue.createApp({
    ...
    methods: {
        ...
        add() {
            ...
            axios.post('/bookmark/add', Qs.stringify({ 'url': this.url }))
                .then((res) => {
                    if (res.success) {
                        this.list()
                        axios.post('/bookmark/update', Qs.stringify({ 'id': res.detail }))
                            .then((res) => {
                                if (res.success) {
                                    this.list()
                                } else {
        ...
        del(id) {
            axios.post('/bookmark/delete', Qs.stringify({ 'id': id }))
                .then((res) => {
                    if (res.success) {
                        this.list()
                    } else {
